...
--
-- Servidor: localhost
-- Tiempo de generación: 25-03-2022 a las 03:18:13
...
CREATE TABLE `comentarios` (
  `id` int(11) NOT NULL,
  `comentario1` varchar(50) DEFAULT NULL,
...
INSERT INTO `comentarios` (`id`, `comentario1`, `id_menu`, `id_plato`) VALUES
(1234, 'verano', 11, 1),
(1543, 'ligero', 13, 3),
(1765, 'festivo', 12, 2);
...
INSERT INTO `plato` (`id`, `nombreplato`, `tipoplato`, `precio`, `id_menu`) VALUES
(1, 'pescadofrito', 'entrada', 100, 11),
(2, 'paella', 'postre', 500, 12),
(3, 'pizza', 'merienda', 200, 13);
...
ALTER TABLE `comentarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `platoo` (`id_plato`),
  ADD KEY `menuu` (`id_menu`);
...
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `menuu` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id`),
  ADD CONSTRAINT `platoo` FOREIGN KEY (`id_plato`) REFERENCES `plato` (`id`);
